 ...
 * Playwright is used ONLY for harvesting headers/cookies.
 */
@Slf4j
...
public class Bet9jaOddsFetcher implements Runnable {
    ...
    @Override
    public void run() {
        log.info("=== Starting Bet9jaOddsFetcher (OkHttp + Context Pool) ===");
...
//new HeadersInterceptor(profile, harvestedHeaders, SPORT_PAGE, cookieHeaderRef.get()
    ...
    private void processParsedEvent(Bet9jaEvent event) {
