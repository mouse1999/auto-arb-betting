...
//    private static final String SPORT_PAGE = BASE_URL ;
...
//                    .header("platform", "web")
                    ...
                    .header("Accept", "*/*")
                    .header("Accept-Language", "en-US,en;q=0.9")  // Changed from "en-US,en;q=0.9" to match exactly
...
//                    .header("OkHttp-Content-Encoding", "identity")
    ...
    //api/ng/facts-center/query/frontend/live-matches?sportId
    ...
    private void processParsedEvent(MSportEvent event, long dataAge) {
        ...
        try {
            ...
            log.info("✅✅ successfully normalize event {}✅✅", event.getEventId());
    ...
    private void attachNetworkTaps(Page page, Map<String, String> store) {
        ...
        page.onRequest(request -> {
            ...
            if (url.contains("api/ng/facts-center/query/frontend/live-matches?sportId=") &&
        ...
        page.onResponse(resp -> {
            ...
            if (url.contains("/api/ng/facts-center/query/frontend/live-matches") && status >= 200 && status < 400) {
    ...
    //https://www.msport.com/api/ng/facts-center/query/frontend/match/detail?eventId=sr:match:63014359
