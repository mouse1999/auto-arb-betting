...
public enum SportyMarketType implements MarketType {
    ...
    BASKETBALL_FT_OU_1695_OVER("225", "total=169.5", "OVER_169.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_169_5),
    BASKETBALL_FT_OU_1695_UNDER("225", "total=169.5", "UNDER_169.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_169_5),
    BASKETBALL_FT_OU_1705_OVER("225", "total=170.5", "OVER_170.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_170_5),
    BASKETBALL_FT_OU_1705_UNDER("225", "total=170.5", "UNDER_170.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_170_5),
    BASKETBALL_FT_OU_1715_OVER("225", "total=171.5", "OVER_171.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_171_5),
    BASKETBALL_FT_OU_1715_UNDER("225", "total=171.5", "UNDER_171.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_171_5),
    BASKETBALL_FT_OU_1725_OVER("225", "total=172.5", "OVER_172.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_172_5),
    BASKETBALL_FT_OU_1725_UNDER("225", "total=172.5", "UNDER_172.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_172_5),
    BASKETBALL_FT_OU_1735_OVER("225", "total=173.5", "OVER_173.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_173_5),
    BASKETBALL_FT_OU_1735_UNDER("225", "total=173.5", "UNDER_173.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_173_5),
    BASKETBALL_FT_OU_1745_OVER("225", "total=174.5", "OVER_174.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_174_5),
    BASKETBALL_FT_OU_1745_UNDER("225", "total=174.5", "UNDER_174.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_174_5),
    BASKETBALL_FT_OU_1755_OVER("225", "total=175.5", "OVER_175.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_175_5),
    BASKETBALL_FT_OU_1755_UNDER("225", "total=175.5", "UNDER_175.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_175_5),
    BASKETBALL_FT_OU_1765_OVER("225", "total=176.5", "OVER_176.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_176_5),
    BASKETBALL_FT_OU_1765_UNDER("225", "total=176.5", "UNDER_176.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_176_5),
    BASKETBALL_FT_OU_1775_OVER("225", "total=177.5", "OVER_177.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_177_5),
    BASKETBALL_FT_OU_1775_UNDER("225", "total=177.5", "UNDER_177.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_177_5),
    BASKETBALL_FT_OU_1785_OVER("225", "total=178.5", "OVER_178.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_178_5),
    BASKETBALL_FT_OU_1785_UNDER("225", "total=178.5", "UNDER_178.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_178_5),
    BASKETBALL_FT_OU_1795_OVER("225", "total=179.5", "OVER_179.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.OVER_179_5),
    BASKETBALL_FT_OU_1795_UNDER("225", "total=179.5", "UNDER_179.5", MarketCategory.OVER_UNDER_TOTAL, OutcomeType.UNDER_179_5),


    // 3. 1st Half Over/Under (ID: 68)
    BASKETBALL_1H_OU_845_OVER("68", "total=84.5", "OVER_84.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_84_5),
    BASKETBALL_1H_OU_845_UNDER("68", "total=84.5", "UNDER_84.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_84_5),
    BASKETBALL_1H_OU_855_OVER("68", "total=85.5", "OVER_85.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_85_5),
    BASKETBALL_1H_OU_855_UNDER("68", "total=85.5", "UNDER_85.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_85_5),
    BASKETBALL_1H_OU_865_OVER("68", "total=86.5", "OVER_86.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_86_5),
    BASKETBALL_1H_OU_865_UNDER("68", "total=86.5", "UNDER_86.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_86_5),
    BASKETBALL_1H_OU_875_OVER("68", "total=87.5", "OVER_87.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_87_5),
    BASKETBALL_1H_OU_875_UNDER("68", "total=87.5", "UNDER_87.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_87_5),
    BASKETBALL_1H_OU_885_OVER("68", "total=88.5", "OVER_88.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_88_5),
    BASKETBALL_1H_OU_885_UNDER("68", "total=88.5", "UNDER_88.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_88_5),
    BASKETBALL_1H_OU_895_OVER("68", "total=89.5", "OVER_89.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_89_5),
    BASKETBALL_1H_OU_895_UNDER("68", "total=89.5", "UNDER_89.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_89_5),
    BASKETBALL_1H_OU_905_OVER("68", "total=90.5", "OVER_90.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_OVER_90_5),
    BASKETBALL_1H_OU_905_UNDER("68", "total=90.5", "UNDER_90.5", MarketCategory.OVER_UNDER_1STHALF, OutcomeType.BASKETBALL_1H_UNDER_90_5),
