...
public enum MSportMarketType implements MarketType {
    ...
    ASIAN_HANDICAP_HOME_MINUS_15("16", "hcp=-1.5","HOME_(-1.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_MINUS_1_5),
    ASIAN_HANDICAP_AWAY_PLUS_15("16", "hcp=-1.5", "AWAY_(+1.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_PLUS_1_5),
    ASIAN_HANDICAP_HOME_MINUS_25("16", "hcp=-2.5","HOME_(-2.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_MINUS_2_5),
    ASIAN_HANDICAP_AWAY_PLUS_25("16", "hcp=-2.5", "AWAY_(+2.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_PLUS_2_5),
    ASIAN_HANDICAP_HOME_MINUS_35("16", "hcp=-3.5","HOME_(-3.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_MINUS_3_5),
    ASIAN_HANDICAP_AWAY_PLUS_35("16", "hcp=-3.5", "AWAY_(+3.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_PLUS_3_5),
    ASIAN_HANDICAP_HOME_MINUS_45("16", "hcp=-4.5","HOME_(-4.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_MINUS_4_5),
    ASIAN_HANDICAP_AWAY_PLUS_45("16", "hcp=-4.5", "AWAY_(+4.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_PLUS_4_5),

    //ASIAN HANDICAP +ve

    ASIAN_HANDICAP_HOME_PLUS_05("16", "hcp=0.5","HOME_(+0.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_PLUS_0_5),
    ASIAN_HANDICAP_AWAY_MINUS_05("16", "hcp=0.5", "AWAY_(-0.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_MINUS_0_5),

    ASIAN_HANDICAP_HOME_PLUS_15("16", "hcp=1.5","HOME_(+1.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_PLUS_1_5),
    ASIAN_HANDICAP_AWAY_MINUS_15("16", "hcp=1.5", "AWAY_(-1.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_MINUS_1_5),

    ASIAN_HANDICAP_HOME_PLUS_25("16", "hcp=2.5","HOME_(+2.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_PLUS_2_5),
    ASIAN_HANDICAP_AWAY_MINUS_25("16", "hcp=2.5", "AWAY_(-2.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_MINUS_2_5),

    ASIAN_HANDICAP_HOME_PLUS_35("16", "hcp=3.5","HOME_(+3.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_PLUS_3_5),
    ASIAN_HANDICAP_AWAY_MINUS_35("16", "hcp=3.5", "AWAY_(-3.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_MINUS_3_5),

    ASIAN_HANDICAP_HOME_PLUS_45("16", "hcp=4.5","HOME_(+4.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_HOME_PLUS_4_5),
    ASIAN_HANDICAP_AWAY_MINUS_45("16", "hcp=4.5", "AWAY_(-4.5)", MarketCategory.ASIAN_HANDICAP_FULLTIME, OutcomeType.ASIAN_HANDICAP_AWAY_MINUS_4_5),
    ...
    BTTS_YES("29", null, "YES", MarketCategory.BTTS, OutcomeType.BOTH_TEAMS_TO_SCORE_YES),
    BTTS_NO("29", null, "NO", MarketCategory.BTTS, OutcomeType.BOTH_TEAMS_TO_SCORE_NO),
